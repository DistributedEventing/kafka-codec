...
public class CompactNullableArray<T extends Value> extends CompactArray<T> implements NullableValue {

    protected boolean isNull;

    public CompactNullableArray(final ValueFactory<T> elementFactory) {
